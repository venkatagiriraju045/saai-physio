                ...
                <div className="form-in-patient-billing-container">
                    <div className="in-patient-billing-row">
                        <div className="in-patient-billing-col">
                            ...
                            {patientDetails.name !== '' && (<>
                                <p className="in-patient-billing-patient-details"><span className="in-patient-billing-patient-name">{patientDetails.name}-{patientDetails.age}</span> <span className="in-patient-billing-patient-status">In-Patient</span></p>
