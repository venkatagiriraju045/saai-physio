...
const OverlayRecord = (mobileNumber) => {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            await fetchPatienRecord(foundPatientBasicRecord.mobileNo);
            setError('');
            console.log("search");
        } catch (error) {
    ...
    const fetchPatienRecord = async (mobileNo) => {
        try {
            ...
            if (foundPatientRecord && foundPatientRecord !== "kulukulu") {
                ...
                console.log("rec fou : ", foundPatientRecord);
                ...
                // Adjust the condition as needed based on the actual response
                console.log("not working");
                // Handle the error or status here, for example:
