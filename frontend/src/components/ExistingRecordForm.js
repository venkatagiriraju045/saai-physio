                                    ...
                                    <tr key={item.label}>
                                        ...
                                        {['normal', 'abnormal'].map((column) => (
                                            <React.Fragment key={column}>
                                                <td>
                                                    {patientRecord.coordination[item.name][column] ? 'Yes' : ''}
                                                </td>
                                            </React.Fragment>
                                        ))}
                                        <td>
                                ...
                                {standingWalkingItems.map((item) => (
                                    <tr key={item.label}>
                                        ...
                                        {['normal', 'abnormal'].map((column) => (
                                            <React.Fragment key={column}>
                                                <td>
                                                    {patientRecord.standingWalking[item.name][column] ? 'Yes' : ''}
                                                </td>
                                            </React.Fragment>
                                        ))}
                                        <td>
                                ...
                                {balanceItems.map((item) => (
                                    <tr key={item.label}>
                                        ...
                                        {['normal', 'abnormal'].map((column) => (
                                            <React.Fragment key={column}>
                                                <td>
                                                    {patientRecord.balance[item.name][column] ? 'Yes' : ''}
                                                </td>
                                            </React.Fragment>
                                        ))}
                                        <td>
                                ...
                                {handFunctionItems.map((item) => (
                                    <tr key={item.label}>
                                        ...
                                        {['normal', 'abnormal'].map((column) => (
                                            <React.Fragment key={column}>
                                                <td>
                                                    {patientRecord.handFunction[item.name][column] ? 'Yes' : ''}
                                                </td>
                                            </React.Fragment>
                                        ))}
                                        <td>
                                ...
                                {prehensionItems.map((item) => (
                                    <tr key={item.label}>
                                        ...
                                        {['normal', 'abnormal'].map((column) => (
                                            <React.Fragment key={column}>
                                                <td>
                                                    {patientRecord.prehension[item.name][column] ? 'Yes' : ''}
                                                </td>
                                            </React.Fragment>
                                        ))}
                                        <td>
